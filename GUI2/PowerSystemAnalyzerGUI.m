classdef PowerSystemAnalyzerGUI < matlab.apps.AppBase
    ...
    methods (Access = public)
        ...
        function createComponents(app)
            ...
            app.UIFigure.Position = [100 100 1150 650]; % Increased width
            ...
            app.LoadFlowResultsTabGroup.Position = [20 20 800 500]; % Increased width
            ...
            app.LoadFlowUITable.Position = [15 50 770 400]; % Increased width
